...
public class A12_2020_06492 extends JFrame implements ActionListener {
    ...
    private JLabel labelNIP = new JLabel("NIP"),
            ...
            labelPembuat = new JLabel("Created By Andreas Marcelino | A12.2020.06492");
    ...
    public A12_2020_06492() {
        ...
        labelNamaPegawai.setBounds(195, 15, 120, 15);
        fieldNamaPegawai.setBounds(195, 35, 150, 25);

        labelMasaKerja.setBounds(15, 75, 120, 15);
        fieldMasaKerja.setBounds(15, 95, 150, 25);

        labelTunjanganJabatan.setBounds(195, 75, 120, 15);
        fieldTunjanganJabatan.setBounds(195, 95, 150, 25);

        labelPotongan.setBounds(375, 75, 120, 15);
        fieldPotongan.setBounds(375, 95, 150, 25);

        buttonHitung.setBounds(15, 315, 100, 25);

        labelGajiPokok.setBounds(15, 135, 120, 15);
        fieldGajiPokok.setBounds(15, 155, 150, 25);

        labelGajiKotor.setBounds(15, 195, 120, 15);
        fieldGajiKotor.setBounds(15, 215, 150, 25);

        labelGajiBersih.setBounds(15, 255, 120, 15);
        fieldGajiBersih.setBounds(15, 275, 150, 25);

        labelPembuat.setBounds(15, 355, 375, 15);
        setPreferredSize(new Dimension(555, 430));
    ...
    public static void main(String[] args) {
        new A12_2020_06492().setVisible(true);
    }
