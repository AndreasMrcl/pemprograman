...
public class CetakBarang06492 extends JFrame implements ActionListener {
    ...
    public static void main(String[] args) {
        new CetakBarang06492().setVisible(true);
    }
        ...
        try {
            ...
            pjob.setPrintable(new Printable() {
                public int print(Graphics g1, PageFormat pf, int pageNum) {
                    ...
                    g1.drawString("Create by Andreas Marcelino | A12.2020.06492", 50, 70);
                    // cetak data....................................
                    try {
