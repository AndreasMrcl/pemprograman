...
public class Login06492 extends JFrame implements ActionListener, FocusListener {
    ...
    public Login06492() {
        ...
        lNip.setBounds(15, 20, 90, 25);
        lNama.setBounds(15, 55, 90, 25);
        lPassword.setBounds(15, 90, 90, 25);

        /* Mengatur letak objek Text Di Container */
        fNip.setBounds(110, 20, 170, 25);
        fNama.setBounds(110, 55, 170, 25);
        fPassword.setBounds(110, 90, 170, 25);
        fPassword.setEchoChar('*');

        fNip.setToolTipText("Isi Nip dengan Angka !");

        /* Mengatur letak objek Button di Container */
        btnOk.setBounds(195, 140, 85, 25);
        btnOk.setLabel("Masuk");
        btnOk.setBackground(Color.green);
        btnBatal.setBounds(95, 140, 85, 25);
    ...
    public static void main(String[] args) {
        new Login06492().setVisible(true);
    }
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (obj == btnOk) {
            ...
            if (xcari == 1) {
                this.dispose();
                FMenu06492 xmenu = new FMenu06492();
    ...
    int CariPassword() {
        ...
        try {
            ...
            String strsql = "SELECT * FROM pegawai WHERE nip ='" + fNip.getText() + "' and password ='"
                    + fPassword.getText() + "'";
            ResultSet rs = stat.executeQuery(strsql);
