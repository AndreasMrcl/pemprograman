...
public class FPegawai06492 extends JFrame implements ActionListener {
    ...
    private JComboBox fJenisKel = new JComboBox<>(gender);
    ...
    public FPegawai06492() {
        ...
        lNip.setBounds(20, 55, 100, 25);
        lNama.setBounds(20, 90, 100, 25);
        lBagian.setBounds(20, 125, 100, 25);
        lJenisKel.setBounds(240, 125, 100, 25);
        ...
        lcreate.setBounds(360, 435, 300, 25);
        lcreate.setText("Create by Andreas Marcelino | A12.2020.06492");

        /* Mengatur letak objek Text Di Container */
        fNip.setBounds(115, 55, 100, 25);
        fNama.setBounds(115, 90, 320, 25);
        fBagian.setBounds(115, 125, 100, 25);
        fJenisKel.setBounds(335, 125, 100, 25);
        fPassword.setBounds(115, 160, 100, 25);

        fNip.setToolTipText("Isi Nip dengan Angka !");

        /* Mengatur letak objek Button di Container */
        btnAdd.setBounds(20, 200, 85, 25);
        btnAdd.setText("Tambah");
        btnAdd.setBackground(Color.green);
        btnAdd.setForeground(Color.getHSBColor(0, 0, 0));
        btnCari.setBounds(120, 200, 85, 25);
        btnCari.setText("Cari");
        btnKoreksi.setBounds(220, 200, 85, 25);
        btnKoreksi.setText("Koreksi");
        btnHapus.setBounds(320, 200, 85, 25);
        btnHapus.setText("Hapus");
        btnSelesai.setBounds(535, 395, 85, 25);
        ...
        skrTabel.setBounds(20, 240, 600, 145);
        ...
        fJenisKel.addActionListener(this);
    ...
    public static void main(String[] args) {
        ...
        new FPegawai06492().setVisible(true);
    }
    ...
    void Add() {
        try {
            ...
            String strsql = "insert into pegawai(nip,nama,bagian,jeniskelamin,password) values " +
                    ...
                    ",'" + fBagian.getText() + "','" + fJenisKel.getSelectedItem() + "','" + fPassword.getText() + "')";
    ...
    int Cari() {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                fJenisKel.setSelectedItem(rs.getString("jeniskelamin"));
    ...
    void Koreksi() {
        try {
            ...
            String strsql = "update pegawai set nama='" + fNama.getText() +
                    ...
                    "',jeniskelamin='" + fJenisKel.getSelectedItem() +
